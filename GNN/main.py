...
# Load best model
    ...
    all_errors, all_actual, all_predicted, all_actual_binary, all_predicted_binary = evaluate_sample_predictions(current_params, movies_df, n_users=80, n_samples_per_user=40, rating_threshold=3.5)
